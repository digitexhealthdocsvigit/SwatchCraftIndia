        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-4xl mx-auto bg-navy text-white rounded-3xl p-6 overflow-hidden relative border border-white/10 shadow-2xl">
             <div className="flex items-center space-x-6">
                <span className="bg-gold text-navy text-[10px] font-black px-3 py-1.5 rounded-lg uppercase shrink-0 animate-pulse">Live 2025 Trend Ticker</span>
      ...
      <section className="bg-navy py-24 px-4 mx-4 rounded-[3rem] text-center text-white overflow-hidden relative">
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
            ...
            <button className="bg-gold text-navy font-black py-5 px-10 rounded-2xl hover:scale-105 transition-all shadow-xl uppercase tracking-widest text-xs">Get Free Guide</button>
          </form>
        </div>
