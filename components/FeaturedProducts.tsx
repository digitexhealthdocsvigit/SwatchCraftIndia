      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, idx) => (
            <div key={idx} className={`bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col group border border-gray-100 ${product.isCustom ? 'bg-teal/5' : ''}`}>
              <div className="aspect-[4/3] bg-gray-100 flex items-center justify-center p-6 border-b border-gray-100 relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-teal text-white text-[10px] font-bold px-3 py-1 rounded-full z-20 shadow-sm">
                  MOQ: {product.moq}
                </div>
              </div>
              <div className="p-8 flex-grow">
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-50">
                   ...
                   <button className="text-teal font-bold text-xs uppercase tracking-wider hover:text-gold transition-colors flex items-center">
                    Get Quote 
